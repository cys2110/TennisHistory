...
definePageMeta({ name: "surfaces", layout: "dashboard-layout" })
...
// API call
const { data } = await useFetch<SurfacesAPIResponse>("/api/all-surfaces", {
      ...
      <template #body>
        ...
        >
          <u-page-card
            ...
            :key="surface"
            :title="surface"
            :to="{ name: 'surface', params: { id: useChangeCase(surface, 'kebabCase').value } }"
            highlight
