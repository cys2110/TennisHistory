import type { CategoryEnum, MonthNameEnum, SurfaceEnum } from "~/types/enums"

const useUpcomingTournaments = async (surfaces: SurfaceEnum[], months: MonthNameEnum[], categories: CategoryEnum[]) => {
...
export default useUpcomingTournaments
