...
const { tour, draw } = destructureMid(mid)
...
<template>
  <div
    v-if="match"
    class="flex flex-col md:flex-row flex-wrap gap-3 max-w-full mx-auto"
  >
    <div class="flex flex-col gap-8">
      <div
        class="border-2 p-5 rounded-xl flex flex-row justify-between h-fit m-auto gap-8 text-xs md:text-sm w-full"
