...
const { h2h, c1, c2 } = defineProps<{ h2h: { p1: H2HPlayerInterface; p2: H2HPlayerInterface }; c1: CountryInterface; c2: CountryInterface }>()
...
const playerDetails = computed(() => [
  ...
  { title: "Height", p1: h2h.p1.height ? `${h2h.p1.height}cm (${convertToFt(h2h.p1.height)})` : "Unknown", p2: h2h.p2.height ? `${h2h.p2.height}cm (${convertToFt(h2h.p2.height)})` : "Unknown" },
  { title: "Plays", p1: h2h.p1.rh ? handedness(h2h.p1.rh) : "Unknown", p2: h2h.p2.rh ? handedness(h2h.p2.rh) : "Unknown" },
  { title: "Backhand", p1: h2h.p1.bh ? `${h2h.p1.bh}-Handed` : "Unknown", p2: h2h.p2.bh ? `${h2h.p2.bh}-Handed` : "Unknown" },
  { title: "Turned Pro", p1: h2h.p1.pro ?? "Unknown", p2: h2h.p2.pro ?? "Unknown" }
])
</script>
