...
const { player, index, id, country } = defineProps<{ player: H2HPlayerInterface; index: number; id: string; country: CountryInterface }>()
...
<template>
  <div>
    <u-page-card
      ...
      :ui="{
        body: 'w-full',
        root: index === 1 ? 'min-w-66 ring-primary-600 dark:ring-primary-600' : 'min-w-66 ring-emerald-700 dark:ring-emerald-700 shadow-emerald-700 dark:shadow-emerald-500 hover:shadow-emerald-700 dark:hover:shadow-emerald-500'
      }"
      class="2xl:w-1/5"
    >
      <nuxt-img
