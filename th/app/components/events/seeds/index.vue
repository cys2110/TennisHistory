  ...
  >
    ...
    >
      ...
      <template #mainSinglesTeam-cell="{ row }">
        <div
          @click.capture.prevent="devMode ? handleEditSeed(row.original.seed!, 'Singles', 'Main') : undefined"
      ...
      <template #mainSinglesRank-cell="{ cell, row }">
        <div
          @click="devMode ? handleEditSeed(row.original.seed!, 'Singles', 'Main') : undefined"
          :class="{ 'cursor-pointer': devMode }"
        >
      ...
      <template #qualSinglesRank-cell="{ cell, row }">
        <div
          @click="devMode ? handleEditSeed(row.original.seed!, 'Singles', 'Qualifying') : undefined"
          :class="{ 'cursor-pointer': devMode }"
        >
          {{ isDefined(cell.getValue()) ? cell.getValue()!.toLocaleString() : cell.renderValue() }}
        </div>
      ...
      <template #mainDoublesRank-cell="{ cell, row }">
        <div
          @click="devMode ? handleEditSeed(row.original.seed!, 'Doubles', 'Main') : undefined"
          :class="{ 'cursor-pointer': devMode }"
        >
          {{ isDefined(cell.getValue()) ? cell.getValue()!.toLocaleString() : cell.renderValue() }}
        </div>
      ...
      <template #qualDoublesRank-cell="{ cell, row }">
        <div
          @click="devMode ? handleEditSeed(row.original.seed!, 'Doubles', 'Qualifying') : undefined"
          :class="{ 'cursor-pointer': devMode }"
        >
          {{ isDefined(cell.getValue()) ? cell.getValue()!.toLocaleString() : cell.renderValue() }}
        </div>
