...
const rankFields: { label: keyof typeof colors; children: FormFieldInterface<PlayerSchema>[] }[] = [
  {
    label: "Singles",
    children: [
...
const linkFields: { label: string; key: keyof PlayerSchema; color: keyof typeof colors }[] = [
