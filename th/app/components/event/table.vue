...
import { FilterTableHeader, ULink } from "#components"
...
<template>
  <u-table
    ...
    class="scrollbar-thin scrollbar-thumb-primary-600 scrollbar-track-transparent lg:max-w-9/10 mx-auto xl:max-w-full"
  >
