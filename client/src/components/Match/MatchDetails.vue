...
<template>
    <a-descriptions bordered size="middle" class="my-10 bg-violet-800">
        ...
        <a-descriptions-item label="Surface" class="bg-black">{{ SURFACES[round.event.surface.id] ?? '—'
            }}</a-descriptions-item>
        ...
        <a-descriptions-item label="Umpire" class="bg-black">{{ umpire?.id ?? '—' }}</a-descriptions-item>
    </a-descriptions>
</template>