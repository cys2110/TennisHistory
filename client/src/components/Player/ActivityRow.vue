  ...
  <a-row class="flex items-center">
    ...
    <a-col :span="1" class="flex justify-end">
      <div>
        <a-image
          ...
          :src="flag(opponent.player.player.country.id)"
          class="rounded"
        />
      </div>
    </a-col>
    <a-col :span="1">
      <a-avatar
        ...
        :src="headshot(opponent.player.player.id)"
        class="border-zinc-300 mx-2"
      />
    </a-col>
    <a-col :span="10" class="pl-3">
      ...
      <router-link
        ...
        :to="{
          name: 'player',
          params: {
            name: encodeName(opponent.player.player.full_name),
            id: opponent.player.player.id,
          },
        }"
        ...
        <router-link
          ...
          :to="{
            ...
            params: {
              p1Name: name,
              p1Id: id,
              p2Name: encodeName(opponent.player.player.full_name),
              p2Id: opponent.player.player.id,
            },
          }"
          >H2H</router-link
        >
