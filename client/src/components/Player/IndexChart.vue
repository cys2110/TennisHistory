...
const data = [
  ...
  { category: 'Other', stat: 'Vs. Right-Handers', win: rhWins.value, loss: rhLosses.value },
  {
    ...
    win: lose1Wins.value,
    loss: lose1Losses.value,
  },
  { category: 'Other', stat: 'After Winning 1st Set', win: win1Wins.value, loss: win1Losses.value },
  {
    category: 'Environment',
    stat: 'Outdoor',
    win: outdoorWins.value,
    loss: outdoorLosses.value,
    titles: outdoorTitles.value,
  },
  {
    category: 'Environment',
    stat: 'Indoor',
    win: indoorWins.value,
    loss: indoorLosses.value,
    titles: indoorTitles.value,
  },
  {
    category: 'Environment',
    stat: 'Carpet',
    win: carpetWins.value,
    loss: carpetLosses.value,
    titles: carpetTitles.value,
  },
  {
    category: 'Environment',
    stat: 'Hard',
    win: hardWins.value,
    loss: hardLosses.value,
    titles: hardTitles.value,
  },
  {
    category: 'Environment',
    stat: 'Grass',
    win: grassWins.value,
    loss: grassLosses.value,
    titles: grassTitles.value,
  },
  {
    category: 'Environment',
    stat: 'Clay',
    win: clayWins.value,
    loss: clayLosses.value,
    titles: clayTitles.value,
  },
  {
    category: 'Pressure Points',
    stat: '5th Set Record',
    win: set5Wins.value,
    loss: set5Losses.value,
  },
  {
    category: 'Pressure Points',
    stat: 'Deciding Set',
    win: deciderWins.value,
    loss: deciderLosses.value,
  },
  ...
  { category: 'Pressure Points', stat: 'Tie breaks', win: tbWins.value, loss: tbLosses.value },
  {
    ...
    win: mastersWins.value,
    loss: mastersLosses.value,
    titles: mastersTitles.value,
  },
  {
    category: 'Match Record',
    stat: 'Grand Slams',
...
const option = ref({
  ...
  tooltip: {
    formatter: function (params) {
      ...
      return `${stat}<br/ >W-L: ${wins}-${losses} (${index})${
        titles >= 0 ? `<br />Titles.value: ${titles}` : ''
      }`
    },
  },
  dataset: {
