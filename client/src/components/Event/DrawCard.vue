...
<template>
    <a-card class="my-1">
        <a-row>
            <a-col :span="19">
                <PlayerRow v-if="match.p1?.player" :player="match.p1.player.player"
        ...
        <a-row class="mt-5">
            <a-col :span="19">
                <PlayerRow v-if="match.p2?.player" :player="match.p2.player.player"
        ...
        <template #actions>
            ...
            <div class="flex justify-center">
                ...
                <div v-else class="border-zinc-300 border-[1.5px] rounded-full px-4 border-dashed">
                    <router-link class="!text-zinc-300 hover:!text-zinc-400"
                        :to="{ name: 'h2h', params: { p1Name: encodeName(match.p1.player.player.full_name), p1Id: match.p1.player.player.id, p2Name: encodeName(match.p2.player.player.full_name), p2Id: match.p2.player.player.id } }">
                        H2H
                    </router-link>
                </div>
            </div>
