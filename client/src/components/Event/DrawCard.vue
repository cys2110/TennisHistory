...
import type { ActivityEntry, MatchRound } from '@/utils/interfaces';
...
<template>
    <v-card
        class="bg-indigo-800 my-3 text-zinc-300 text-sm"
        variant="text"
        rounded="xl"
    >
        <v-container>
                ...
                >
                    ...
                    >
                        <flag-img
                            ...
                            class="w-[2rem]"
                            :src="func.flag(match.p1.player.country.id)"
                    ...
                    >
                        ...
                        >
                            <v-img
                                :src="func.headshot(match.p1.player.id)"
                    ...
                    >
                        ...
                        <small
                            v-if="p1Entry?.properties.seed || p1Entry?.properties.status"
                        >
                ...
                >
                    ...
                    >
                        <flag-img
                            ...
                            class="w-[2rem]"
                            :src="func.flag(match.p2.player.country.id)"
                    ...
                    >
                        ...
                        >
                            <v-img
                                :src="func.headshot(match.p2.player.id)"
                    ...
                    >
                        ...
                        <small
                            v-if="p2Entry?.properties.seed || p2Entry?.properties.status"
                        >
