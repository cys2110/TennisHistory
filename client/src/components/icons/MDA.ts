...
const MDA = defineComponent({
  ...
  render() {
    return h(
      ...
      [
        h('path', { fill: '#CE1126', d: 'M.2-1h86.5v57.7H.2z' }),
        h('path', { fill: '#FFD100', d: 'M.2-1h57.7v57.7H.2z' }),
        h('path', { fill: '#0033A0', d: 'M.2-1H29v57.7H.2z' }),
        h('path', {
          fill: '#6B4423',
          d: 'm40.7 32.8 1.5.8-2.8 5.1-1.1.7 1.9.7 1.9-2.2-.3 1.5-.6 1.4 2.3 1.3 2.5-1.5-1.2-2.6.4-.1 1.6 2.3 1.8-.9-2.3-2.7-1.5-3.2 1.6-.5 1.1 1 .1-.6.6.2-.1-.5.6.1L48 32l1.8-1.5 1.1 3.5 1.7 1.9h.3l1.2 1.5V16.7l-2.2-2.3-2.2 1.7.1 1.9-1 .1-1.4.7-.8.3-.4.1-.5-.6-.7-1.3V16l.4-.9-.1-.8h.4l-.2-.5.3-.2-.5-.4.2-.2-1.9-.8-1.4-.1-.3.2-.2.3.3 1.1-.3.4.3.8.1 1.6-.4 1.5-.6 1-.3.1-.8-.1-1.7-.9-1-.1-.1-2-2-1.6-2 2.2-.3.7.1 20 1.3-1.6.3.1 1.4-1.5 1.1-2.9.4-1.2L39 32l-.6 1.1.6-.1v.5l.5-.2.1.6z',
        }),
        h('path', {
          fill: '#010101',
          d: 'M40.4 10.7c-.2 0-.4.1-.5.1.2 0 .3.2.3.4v.5h-.5c-.2 0-.3-.1-.4-.3-.1.1-.1.3-.1.5s.1.4.1.5c0-.2.2-.3.4-.3h.5v2.3c0 .2-.1.3-.3.4.2 0 .4.3.5.5.1-.2.2-.5.5-.5-.2-.1-.3-.2-.3-.4v-2.3h.5c.2 0 .3.1.4.3.1-.1.1-.3.1-.5s-.1-.4-.1-.5c0 .2-.2.3-.4.3h-.5v-.5c0-.2.1-.3.3-.4-.1 0-.3-.1-.5-.1z',
        }),
        h('path', {
          fill: '#FFD700',
          d: 'M40.4 10.8h-.3c.1.1.2.2.2.4v.6h-.6c-.2 0-.3-.1-.4-.2v.6c.1-.1.2-.2.4-.2h.6v2.3c0 .1-.1.3-.2.4.1 0 .1.1.2.2l.1.2.1-.2.2-.2c-.1-.1-.2-.2-.2-.4v-2.4h.6c.2 0 .3.1.4.2v-.6c-.1.1-.2.2-.4.2h-.6v-.6c0-.2.1-.3.2-.4-.1.2-.2.1-.3.1z',
        }),
        h('path', {
          fill: '#D1202C',
          d: 'm36.6 37.5.6-.4.4-.5.2-.5 1.7-2.3-.1-.5-.3.2-.2-.5-.2.1-1.4 2.1h-.7l-.7.3-.2.8.1.3zm13.9-2.3h-.7l-1.4-2.1-.2-.1-.1.4-.4-.1-.2.4 1.9 2.6.2.4.8.8.2-.1.9-1-.2-.7z',
        }),
        h('path', {
          fill: '#010101',
          d: 'm37.5 36.9 1 .6-.3 1.2-1-.6zm-4.9-11.1-.4.2 4.2 9.3h.4l-4.2-9.5zm5 10.9-.3.3.2.4.4-.2-.3-.5z',
        }),
        h('path', { fill: '#FFD700', d: 'm37.6 37.3.7.3-.2.7-.6-.3z' }),
        h('path', {
          fill: '#2E50A3',
          d: 'M37.4 25.7v5l.4.6 2.3 1.2 3 1.4.4.4 2.6-1.4 3-1.4.5-.9v-4.9z',
        }),
        h('path', {
          fill: '#D1202C',
          d: 'm37.3 19.7.2.4v5.7l.2.2 1.8.2 1.9-.3s1.1.2 1.9.3v.1s.3 0 .4-.1c.1 0 .4.1.4.1v-.1c.8-.1 1.9-.3 1.9-.3l1.9.3 1.8-.2.2-.2v-5.7l.2-.4H37.3z',
        }),
        h('path', {
          fill: '#010101',
          d: 'M41.3 26s-1.3-.3-1.8-1c-.9.8-1.9 1-1.9 1s1.1.5 1.9 1.1c.4-.4 1.8-1.1 1.8-1.1zm4.5 0s1.4.6 1.8 1.2c.8-.6 1.9-1.1 1.9-1.1s-1-.3-1.9-1c-.5.6-1.8.9-1.8.9zm-2.3-5.8-.4 1-1-.5.5 1-1 .4 1 .4-.5 1 1-.5.4 1 .4-1 1 .5-.5-1 1-.4-1-.4.5-1-1 .5-.4-1z',
        }),
        h('path', {
          fill: '#FFD700',
          d: 'm41.8 27.6.4.4-.4.3-.4-.4zm3.5-.1-.4.4.3.4.5-.4zm0 2.1.3-1-.8.1-.1.5-.1 1.1.3.7.4.1zm-3.1-.9-.7-.1.3 1.3v1.2l.3-.3.3-.5v-1zm4.3.7-.4.5-.1.8.6.7h.2l-.1-.8.7-.8.7-.2-.8-.4zm-5.6 1-.2-.2.3-.1.1-.5-.4-.5-.3.1-.2.1-.1-.3-.5-.3-.3.2-.2.4.1.3h-.4l-.3.3-.1.4.3.2.3.1h.1l-.1.4.1.3.4.2.4-.1.2-.4.3.3.4-.1.3-.4z',
        }),
        h('path', {
          fill: '#FFD100',
          d: 'm43.5 20.9.2.7.6-.3-.3.6.7.2-.7.2.3.6-.6-.3-.2.7-.2-.7-.6.4.3-.6-.7-.2.7-.2-.3-.6.6.3.2-.8z',
        }),
        h('path', {
          fill: '#010101',
          d: 'M41.4 20c-.1.4-2.2 1.3-2.2 3.1 0 2.3 2.1 2.8 2.1 2.8v.1l-.5 1s.9 0 1.3.4c.6.5.5 1.5.5 2.2 0 .6-.1 1.2-.4 1.4-.4.3-.7.4-.7.8 0 .3.3.4.7.6.5.3.5.7 1.3.7s.8-.4 1.3-.7c.4-.2.7-.3.7-.6 0-.4-.3-.4-.7-.8-.3-.3-.4-.9-.4-1.4 0-.7-.1-1.7.5-2.2.5-.4 1.3-.4 1.3-.4l-.4-1-.1-.2s2.1-.5 2.1-2.8c0-1.8-2.1-2.6-2.2-3.1-.2.7.7 1.7.7 2.9 0 1.5-1.1 1.6-1.1 1.6-.3 0-.4.2-.5.2-.2 0-.3-.3-.6-.3l-.6.3c-.3 0-.4-.3-.6-.3-.2 0-.3.3-.6.3-.1 0-.2-.2-.5-.2 0 0-1.1-.1-1.1-1.6 0-1 .9-2.1.7-2.8z',
        }),
        h('path', {
          fill: '#FFD100',
          d: 'M39.5 25.4c.4.5 1.1.7 1.1.7l-1.1.8-1.2-.8c-.1 0 .7-.2 1.2-.7zm1.6-4.7c.1.2-.7 1.3-.7 2.3 0 1.2.6 1.8 1.4 1.8l.5.2.6-.3c.2 0 .3.3.6.3s.5-.3.6-.3c.1 0 .3.3.6.3.1 0 .3-.2.5-.2.8 0 1.4-.7 1.4-1.8 0-.9-.8-2.1-.7-2.3 0 0 1.6 1.1 1.6 2.4 0 2.1-2.1 2.6-2.1 2.6l.5 1.1s-.7.1-1.1.4c-.5.4-.5 1.6-.5 2.4 0 .9 0 1.3.4 1.6.4.3.6.3.6.6 0 .2-.3.3-.6.5-.4.2-.5.5-1 .5-.6 0-.6-.3-1-.5s-.6-.3-.6-.5c0-.3.3-.3.6-.6s.4-.7.4-1.6c0-.8 0-2-.5-2.4-.4-.3-1.1-.4-1.1-.4l.5-1.1s-2.1-.5-2.1-2.6c-.3-1.3 1.2-2.4 1.2-2.4zm6.5 4.7c.5.5 1.2.7 1.2.7s-.8.4-1.2.8c-.4-.4-1.1-.8-1.1-.8s.7-.2 1.1-.7z',
        }),
        h('path', {
          fill: '#010101',
          d: 'm41.8 27.4-.5.5.5.5.5-.5-.5-.5zm3.5 0-.5.5.5.5.5-.5-.5-.5z',
        }),
        h('path', {
          fill: '#FFD100',
          d: 'm41.8 27.7.3.3-.3.3-.3-.3.3-.3zm3.5 0 .3.3-.3.3-.3-.4.3-.2z',
        }),
        h('path', {
          fill: '#010101',
          d: 'M41.3 28.4c.1.2.3 1 .3 2 0 .6-.1 1-.1 1s.7-.2.9-.9c.1-.3.1-1.6-.2-1.8l-.9-.3zm4.4 0-.9.2c-.3.2-.3 1.5-.2 1.8.1.7.9.9.9.9s-.1-.3-.1-1c0-.8.2-1.6.3-1.9zm-6.1.2h-.1c-.3.1-.5.4-.4.7 0 0 0 .1.1.1H39c-.3 0-.6.3-.6.6s.2.6.6.6h.1l-.1.1c-.1.3 0 .7.3.8.3.1.7 0 .8-.3v-.1l.1.1c.3.2.6.2.8-.1.2-.3.2-.6-.1-.8l-.1-.1s.1 0 .1-.1c.3-.2.4-.6.2-.8-.1-.2-.3-.3-.5-.3-.1 0-.2 0-.3.1l-.1.1v-.1c-.1-.3-.3-.5-.6-.5z',
        }),
        h('path', {
          fill: '#FFD100',
          d: 'm41.7 28.7.5.1c.2.3.2.7.2 1.2 0 .6-.4.8-.4.8-.1-1.3-.2-1.7-.3-2.1zm3.7 0c-.1.4-.2.8-.2 2.2 0 0-.4-.2-.4-.8 0-.6 0-1 .2-1.2l.4-.2zm-5.8.2c.2 0 .4.1.5.4v.3h-.2c-.2 0-.4.1-.5.2l-.1-.1s0-.1-.1-.1c-.1-.4.1-.6.4-.7z',
        }),
        h('path', {
          fill: '#010101',
          d: 'M47.1 29.1c-.8 0-1.3.6-1.3 1.3.1.6.6 1.1 1.2 1.3-.1-.2-.2-.4-.2-.6-.1-.7.5-1.3 1.3-1.3h.4c-.3-.4-.8-.7-1.4-.7z',
        }),
        h('path', {
          fill: '#FFD100',
          d: 'M40.6 29.3c.2 0 .3.1.4.2.1.2.1.5-.1.6 0 0-.1 0-.1.1h-.1c0-.3-.2-.5-.4-.6 0 0 0-.1.1-.1l.1-.1c-.1-.1 0-.1.1-.1zm6.5.1c.2 0 .5.1.7.2-.8.1-1.3.8-1.2 1.6-.2-.2-.4-.5-.4-.8-.1-.6.3-1 .9-1zm-8 .2h.2s.1 0 .1.1c-.1.1-.1.3-.1.4 0 .1 0 .2.1.3 0 0-.1 0-.1.1h-.1c-.3 0-.5-.2-.4-.5-.2-.2 0-.4.3-.4zm.8.1c.3 0 .5.2.5.5s-.2.5-.5.5-.5-.2-.5-.5.2-.5.5-.5zm.6.5h.1s.1 0 .1.1c.2.2.2.5.1.7-.2.2-.5.2-.7.1L40 31v-.1c.3-.2.5-.4.5-.7zm-1.2.4c.1.2.3.3.6.3h.1v.2c-.1.2-.4.4-.6.3-.2-.1-.4-.4-.3-.6 0-.1.1-.1.2-.2z',
        }),
        h('path', {
          fill: '#010101',
        ...
        h('path', {
          fill: '#FFD700',
          d: 'M34.8 31c-.1.1-.3-.5-.5-.9-.2-.3-.5-.8-.4-.9.1 0 .2.2.4.6.2.4.6 1.2.5 1.2zm-1.4-3.1c-.1.1-.3-.3-.4-.7-.2-.3-.3-.6-.2-.6.1 0 .2.2.4.5 0 .4.3.8.2.8zm3.2 7.1c-.1 0-.6-.9-.9-1.8-.4-.8-.7-1.5-.6-1.5.1 0 .4.7.8 1.5.3.9.8 1.7.7 1.8z',
        }),
        h('path', {
          fill: '#CE1126',
          d: 'M40.5 13.1s.2-.3.5-.3h.7c.1.2.4.5.4.8 0 0-.3-.6-1.3-.6-.2.1-.3.1-.3.1z',
        }),
        h('path', { fill: '#010101', d: 'M41.7 13.2s-.2-.1-.2-.2.1-.1.2 0v.2z' }),
        h('path', { fill: '#D1202C', d: 'M42 13.8s-.2.2-.2.3c-.2-.1-.5-.4-.5-.4s.2.1.7.1z' }),
        h('path', {
          fill: '#010101',
          d: 'M43 13.2c0 .1-.1.3-.3.3-.2 0-.3-.1-.3-.3 0-.1.1-.3.3-.3.2.1.3.2.3.3z',
        }),
        h('path', {
          fill: '#FFD700',
          d: 'M42.9 13.2c0 .1-.1.2-.2.2s-.2-.1-.2-.2.1-.2.2-.2.2.1.2.2z',
        }),
        h('path', { fill: '#010101', d: 'M42.8 13.2c0 .1-.1.1 0 0-.1.1-.2.1-.2 0 0 0 0-.1.2 0z' }),
        h('path', {
          fill: '#FFD700',
          d: 'M36.7 19.5s.6.4.6.8v10.1c0 .3.1.4.2.6.1.2.4.4.7.6.9.6 2.4 1.2 3.5 1.7.9.4 1.3.6 1.8 1.2.5-.6.9-.8 1.8-1.2 1.1-.5 2.6-1.1 3.5-1.7.3-.2.6-.4.7-.6.1-.2.2-.3.2-.6v-10c0-.4.6-.8.6-.8l-13.6-.1zm.8.4h12.2s-.2.2-.2.5v10.1c0 .2-.2.7-1.6 1.4-2.2 1.1-3.9 1.6-4.4 2.2-.5-.6-2.2-1.1-4.4-2.2-1.3-.7-1.6-1.2-1.6-1.4V20.4c.1-.3 0-.5 0-.5z',
        }),
      ],
    )
  },
