...
<template>
    <v-card class="my-4 sm:!my-5 !bg-indigo-800 mx-auto h-100 border-zinc-500" rounded="xl" variant="outlined">
        <v-img class="opacity-75 align-end" :src="flag(event.venue.country.id)" :alt="event.venue.country.name">
        ...
        <v-card-subtitle v-if="event.sponsor_name" class="small text-center" style="text-wrap: wrap;">
            {{ event.sponsor_name }}
        </v-card-subtitle>
