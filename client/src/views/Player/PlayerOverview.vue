        ...
        <v-row>
            <v-col class="sm:flex justify-between">
                <div class="w-100 mx-1 text-xs lg:text-sm">
                    ...
                    <div class="my-2 bg-indigo-800 text-zinc-300 py-1 px-3 rounded-lg flex justify-between">
                        <div>Height</div>
                        <div>{{ player.height_cm ? `${player.height_cm}cm (${convertToFt(player.height_cm)})` : '—' }}
                        </div>
                    </div>
                    <div class="my-2 bg-indigo-800 text-zinc-300 py-1 px-3 rounded-lg flex justify-between">
                        <div>Plays</div>
                ...
                <div class="w-100 mx-1 text-xs lg:text-sm">
                    <div class="my-2 bg-indigo-800 text-zinc-300 py-1 px-3 rounded-lg flex justify-between">
                        ...
                        <div v-if="player.dob" class="text-right">
                            <div>{{ Math.floor(Math.abs(DateTime.fromISO(player.dob).diffNow('years').toObject().years))
                                }}</div>
                ...
                <v-table class="bg-transparent rounded-lg" density="comfortable">
                    ...
                    <tbody class="text-zinc-300">
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.aoAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.ao.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="(round, index) in player.ao" :key="round.event.id"
                                        class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.rgAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.rg.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.rg" :key="round.event.id" class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.wimbledonAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.wimbledon.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.wimbledon" :key="round.event.id"
                                        class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.usoAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.uso.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.uso" :key="round.event.id" class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.finalsAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.finals.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.finals" :key="round.event.id" class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.davisAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.davis.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.davis" :key="round.event.id" class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.olympicsAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.olympics.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.olympics" :key="round.event.id"
                                        class="hover-link"
                        ...
                        <tr style="height: 0;">
                            ...
                            <td class="text-center">
                                <span v-if="player.hopmanAgg.node.round.longest">
                            ...
                            <td>
                                <div v-if="player.hopman.length > 0" class="d-flex flex-col py-1">
                                    <router-link v-for="round in player.hopman" :key="round.event.id" class="hover-link"
