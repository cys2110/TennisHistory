...
<template>
    <v-sheet
        class="w-5/6 md:w-8/12 lg:w-1/2 mx-auto my-3 bg-transparent"
    >
        <v-container
            v-if="player"
        >
            <v-row>
                ...
                >
                    <div class="my-10">
                        <div
                            class="my-2 text-center sm:!flex sm:!justify-center md:!justify-start sm:!items-center"
                        >
                            <div
                        ...
                        <div
                            class="flex justify-evenly items-center md:justify-start my-3 lg:!mt-6"
                        >
                            <div
                            ...
                            >
                                ...
                                >
                                    <v-tooltip
                                        v-if="player.countryConnection.edges[0].properties.start_date"
                                        content-class="!bg-indigo-600 !text-zinc-300 !text-sm"
                                        activator="parent"
                                        location="bottom"
                                        height="30"
                                    >
                                        {{ smallDate(player.countryConnection.edges[0].properties.start_date) }}-{{ player.countryConnection.edges[0].properties.end_date ? smallDate(player.countryConnection.edges[0].properties.end_date) : 'present' }}
                                    </v-tooltip>
                                </flag-img>
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    <v-tooltip
                                        ...
                                        height="30"
                                    >
                                        {{ smallDate(country.properties.start_date) }}-{{ smallDate(country.properties.end_date) }}
                                    </v-tooltip>
                                </flag-img>
                            </div>
                        </div>
                    ...
                    <div
                        class="sm:!flex sm:!justify-evenly sm:!items-center bg-indigo-800 rounded-xl p-3 lg:!mt-6"
                    >
                        <div
                            v-if="player.ch_date"
