...
const { match } = defineProps<{
  match: Pick<MatchInterface, "match_no" | "date" | "court" | "duration" | "incomplete" | "umpire" | "winner" | "loser">
}>()
      ...
      <u-button-group size="sm">
        ...
        <u-button
          ...
          :to="{
            name: 'h2h-players',
            params: {
              p1Name: encodeName(match.winner.name),
              p1Id: match.winner.id,
              p2Name: encodeName(match.loser.name),
              p2Id: match.loser.id
            }
          }"
        />
