...
const p1Numbers = computed(() => {
  return {
    ...
    ch: h2h.p1.ch_singles ? h2h.p1.ch_singles : 0
  }
})
...
const p2Numbers = computed(() => {
  return {
    ...
    ch: h2h.p2.ch_singles ? h2h.p2.ch_singles : 0
  }
})
...
const comparisons = computed(() => [
  ...
  {
    title: "Career High",
    p1: h2h.p1.ch_singles ?? "—",
    p2: h2h.p2.ch_singles ?? "—",
    percent: h2h.p1.ch_singles && h2h.p2.ch_singles ? percentage(p1Numbers.value.ch, p1Numbers.value.ch + p2Numbers.value.ch) : null
  }
])
