                ...
                <tr>
                    <td>
                        <div class="d-flex justify-space-between">
                            ...
                            <div class="font-weight-bold" v-else>{{ results.aces }}</div>
                        </div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <div class="d-flex justify-space-between">
                            ...
                            <div class="font-weight-bold" v-if="results === ''">0</div>
                            <div class="font-weight-bold" v-else>{{ results.dfs }}</div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex flex-column my-2">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-space-between">
                            ...
                            <div class="font-weight-bold" v-if="results === ''">0</div>
                            <div class="font-weight-bold" v-else>{{ results.bp_opps }}</div>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <div class="d-flex justify-space-between">
                            ...
                            <div class="font-weight-bold" v-if="results === ''">0</div>
                            <div class="font-weight-bold" v-else>{{ results.bps_faced }}</div>
                        </div>
                    </td>
                    <td>
                        <div class="d-flex flex-column my-2">
